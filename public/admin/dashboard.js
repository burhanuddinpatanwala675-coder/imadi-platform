...
function openCase(item = null) { state.editingCaseId = item?.id || null; $('#case-editor').hidden = false; $('#case-editor-title').textContent = item ? 'Edit case study' : 'New case study'; $('#case-title').value = item?.title || ''; $('#case-slug').value = item?.slug || ''; $('#case-client').value = item?.clientName || ''; $('#case-industry').value = item?.industry || ''; $('#case-status').value = item?.status || 'draft'; $('#case-date').value = item?.publishedAt ? item.publishedAt.slice(0, 10) : ''; $('#case-cover').value = item?.coverImageUrl || ''; $('#case-gallery').value = (item?.galleryImages || []).join('\n'); $('#case-challenge').value = item?.challenge || ''; $('#case-solution').value = item?.solution || ''; $('#case-outcomes').value = item?.outcomes || ''; $('#case-seo-title').value = item?.seoTitle || ''; $('#case-seo-description').value = item?.seoDescription || ''; }
